...
export const i18nDerived = {
	...
	autoSpins: () => stateI18nDerived.translate('AUTOPLAY'),
	numberOfRounds: () => stateI18nDerived.translate('SELECT NUMBER OF ROUNDS'),
	...
	startAutoplay: () => stateI18nDerived.translate('START'),
