...
import {
  ...
  xr,
  yi
} from "./chunk-HCIKNTI7.js";
import {
  require_react
} from "./chunk-RJOG5CHH.js";
import {
  z
} from "./chunk-CYEZY5JR.js";
import {
  dedent
...
// ../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@19.1.8_storybook@9.0.15_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/blocks.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-YQMFR33C.js");
...
var ve = xe(2);
function Ce(e2, t2) {
  let n2 = t2 === 1, i2 = n2 ? be : ve, l2 = n2 ? ye : ke, o2 = n2 ? he : me;
...
`) !== -1 || d2 && c2;
      c2 = u2;
      let p2 = r2.inline, f2 = r2.list, h2;
...
function _e(e2, t2, n2) {
  let r2 = n2.inline || false, i2 = n2.simple || false;
...
function Xe(n2 = "", i2 = {}) {
  function u2(e2, n3, ...r2) {
    ...
    }(e2, i2.overrides), t({}, n3, l2, { className: Qe(n3 == null ? void 0 : n3.className, l2.className) || void 0 }), ...r2);
  }
  function Z2(e2) {
    e2 = e2.replace(w, "");
    let t2 = false;
...
`, { inline: t2 }));
    ...
    let r2 = i2.wrapper || (t2 ? "span" : "div"), l2;
  ...
  i2.overrides = i2.overrides || {}, i2.sanitizer = i2.sanitizer || He, i2.slugify = i2.slugify || Le, i2.namedCodesToUnicode = i2.namedCodesToUnicode ? t({}, o, i2.namedCodesToUnicode) : o, i2.createElement = i2.createElement || React20.createElement;
  let Q2 = [], V2 = {}, X2 = { [r.blockQuote]: { match: De(p), order: 1, parse(e2, t2, n3) {
  ...
  }, render: (e2, n3, r2) => u2(e2.tag, t({}, e2.attrs, { key: r2.key })) }, [r.htmlComment]: { match: Ue(B), order: 1, parse: () => ({}), render: qe }, [r.image]: { match: Ie(Se), order: 1, parse: (e2) => ({ alt: e2[1], target: Pe(e2[2]), title: e2[3] }), render: (e2, t2, n3) => u2("img", { key: n3.key, alt: e2.alt || void 0, title: e2.title || void 0, src: i2.sanitizer(e2.target, "img", "src") }) }, [r.link]: { match: Re($e), order: 3, parse: (e2, t2, n3) => ({ children: Fe(t2, e2[1], n3), target: Pe(e2[2]), title: e2[3] }), render: (e2, t2, n3) => u2("a", { key: n3.key, href: i2.sanitizer(e2.target, "a", "href"), title: e2.title }, t2(e2.children, n3)) }, [r.linkAngleBraceStyleDetector]: { match: Re(N2), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: r.text }], target: e2[1], type: r.link }) }, [r.linkBareUrlDetector]: { match: Me2((e2, t2) => t2.inAnchor || i2.disableAutoLink ? null : Re(D)(e2, t2)), order: 0, parse: (e2) => ({ children: [{ text: e2[1], type: r.text }], target: e2[1], title: void 0, type: r.link }) }, [r.linkMailtoDetector]: { match: Re(U), order: 0, parse(e2) {
    let t2 = e2[1], n3 = e2[1];
...
` }, [r.paragraph]: { match: Me2(Ne), order: 3, parse: Ge, render: (e2, t2, n3) => u2("p", { key: n3.key }, t2(e2.children, n3)) }, [r.ref]: { match: Re(P), order: 0, parse: (e2) => (V2[e2[1]] = { target: e2[2], title: e2[4] }, {}), render: qe }, [r.refImage]: { match: Ie(_), order: 0, parse: (e2) => ({ alt: e2[1] || void 0, ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("img", { key: n3.key, alt: e2.alt, src: i2.sanitizer(V2[e2.ref].target, "img", "src"), title: V2[e2.ref].title }) : null }, [r.refLink]: { match: Re(F), order: 0, parse: (e2, t2, n3) => ({ children: t2(e2[1], n3), fallbackChildren: e2[0], ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("a", { key: n3.key, href: i2.sanitizer(V2[e2.ref].target, "a", "href"), title: V2[e2.ref].title }, t2(e2.children, n3)) : u2("span", { key: n3.key }, e2.fallbackChildren) }, [r.table]: { match: De(H), order: 1, parse: Te, render(e2, t2, n3) {
  ...
  } }, [r.text]: { match: Ue(re), order: 4, parse: (e2) => ({ text: e2[0].replace(T, (e3, t2) => i2.namedCodesToUnicode[t2] ? i2.namedCodesToUnicode[t2] : e3) }), render: (e2) => e2.text }, [r.textBolded]: { match: Ie(J2), order: 2, parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }), render: (e2, t2, n3) => u2("strong", { key: n3.key }, t2(e2.children, n3)) }, [r.textEmphasized]: { match: Ie(K), order: 3, parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }), render: (e2, t2, n3) => u2("em", { key: n3.key }, t2(e2.children, n3)) }, [r.textEscaped]: { match: Ie(te), order: 1, parse: (e2) => ({ text: e2[1], type: r.text }) }, [r.textMarked]: { match: Ie(Y), order: 3, parse: Ge, render: (e2, t2, n3) => u2("mark", { key: n3.key }, t2(e2.children, n3)) }, [r.textStrikethroughed]: { match: Ie(ee), order: 3, parse: Ge, render: (e2, t2, n3) => u2("del", { key: n3.key }, t2(e2.children, n3)) } };
  i2.disableParsingRawHTML === true && (delete X2[r.htmlBlock], delete X2[r.htmlSelfClosing]);
  let oe2 = function(e2) {
...
var index_modern_default = (t2) => {
  ...
  return React20.cloneElement(Xe(r2, i2), l2);
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-C4C7MVEW.js"));
...
var require_is_regex = __commonJS22({ "node_modules/.pnpm/is-regex@1.2.1/node_modules/is-regex/index.js"(exports, module) {
  ...
  hasToStringTag ? ($exec = callBound("RegExp.prototype.exec"), isRegexMarker = {}, throwRegexMarker = function() {
    throw isRegexMarker;
  }, badStringifier = { toString: throwRegexMarker, valueOf: throwRegexMarker }, typeof Symbol.toPrimitive == "symbol" && (badStringifier[Symbol.toPrimitive] = throwRegexMarker), fn = function(value2) {
...
//# sourceMappingURL=chunk-NK77SVID.js.map
