...
} from "./chunk-DDNCPKAE.js";
import {
  __toESM
} from "./chunk-SROXYCZ4.js";

// ../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0_prettier@3.6.2/node_modules/storybook/dist/docs-tools/index.js
  ...
  (function(n, s) {
    ...
    let pr = {
      ...
      JsdocTypeSymbol: r((e) => {
        ...
        return (o == null ? void 0 : o.type) === "JsdocTypeVariadic" && (o.meta.position === "prefix" ? t = "..." : i = true, o = o.element), (o == null ? void 0 : o.type) === "JsdocTypeName" ? t += o.value : (o == null ? void 0 : o.type) === "JsdocTypeNumber" && (t += o.value.toString()), i && (t += "..."), F(`${e.value}(${t})`);
      }, "JsdocTypeSymbol"),
...
var B = r((n) => {
  ...
  switch (typeof a < "u" && (p.raw = a), n.name) {
    ...
    case "signature":
      return { ...p, ...Nr(n) };
    case "union":
      return ((_a = n.elements) == null ? void 0 : _a.every(Sr)) ? { ...p, name: "enum", value: (_b = n.elements) == null ? void 0 : _b.map(Er) } : { ...p, name: s, value: (_c = n.elements) == null ? void 0 : _c.map(B) };
    case "intersection":
      return { ...p, name: s, value: (_d = n.elements) == null ? void 0 : _d.map(B) };
    default:
...
var M = r((n) => {
  ...
  switch (typeof a < "u" && (p.raw = a), n.name) {
    ...
    case "union":
      let c;
      return ((_a = n.elements) == null ? void 0 : _a.every((u) => u.name === "literal")) ? c = {
        ...p,
        name: "enum",
        // @ts-expect-error fix types
        value: (_b = n.elements) == null ? void 0 : _b.map((u) => ie(u.value))
      } : c = { ...p, name: s, value: (_c = n.elements) == null ? void 0 : _c.map(M) }, c;
    case "intersection":
      return { ...p, name: s, value: (_d = n.elements) == null ? void 0 : _d.map(M) };
    default:
      return { ...p, name: "other", value: s };
  }
}, "convert");
...
function Pt(n, s) {
  if (n != null) {
    let { value: a } = n;
    if (!K(a))
      return wt(a) ? w(s == null ? void 0 : s.name, a) : w(a);
  }
  return null;
}
...
function ye(n, s) {
  var _a;
  if (s == null ? void 0 : s.includesJsDoc) {
    let { description: a, extractedTags: p } = s;
    a != null && (n.description = s.description);
    let c = {
      ...p,
      params: (_a = p == null ? void 0 : p.params) == null ? void 0 : _a.map(
        (u) => ({
...
var yn = r((n) => {
  ...
  return n.map((p) => {
    var _a;
    let c = p;
    return ((_a = p.type) == null ? void 0 : _a.elements) && (c = {
      ...p,
      type: {
        ...p.type,
...
//# sourceMappingURL=chunk-JDACI3QJ.js.map
